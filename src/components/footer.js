...
import  Logo from '../../static/logo/logo-dasma.svg'
                ...
                <div className="footer-container footer-grid">
                    ...
                    <nav className="social-media-nav">
                        <ul> 
                            ...
                            <li>
                                <a href="https://www.facebook.com/Chaitanya-Das-Ma-101941505006816/"
                                target="_blank"
                                rel="noreferrer">
                                    <FontAwesomeIcon   
                            ...
                            <li>
                                <a          
                                    target="_blank"
                                    href="https://www.goodreads.com/book/show/55424830-philosophical-poetry"
                                    rel="noreferrer"
                                    >
                ...
                <div className="two-grid-column" id="lower-footer">
                    <p>
                        ...
                        />
                         ...
                         &#169; Copyright {new Date().getFullYear()}. Stratton Press.
                    </p>
