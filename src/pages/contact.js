...
const Contact = (props)=>{
    ...
    return(
        <>
            ...
            <Layout>
		        <Helmet title="Contact | Chaitanya Das Ma" />
                ...
                <main className="flexMainContainer">
                    <div className="flex-container-fx">
                        ...
                        <div className="info-section-address">
                            ...
                            <span>
                                <h5>Phone</h5>
                                <a href="tel:8883237009" style={{color: '#5d5d5d'}}>888-323-7009</a>
                            </span>

                            <span>
                                <h5>Email</h5>
                                <a href="mailto:publish@stratton-press.com" style={{color: '#5d5d5d'}}>publish@stratton-press.com</a>
                            </span>
                        </div>
                    </div>
                </main>
